namespace gprs
{
    partial class TestSensForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblXSens = new System.Windows.Forms.Label();
            txtXSens = new System.Windows.Forms.TextBox();
            lblYSens = new System.Windows.Forms.Label();
            txtYSens = new System.Windows.Forms.TextBox();
            ...
            panelTop.Size = new System.Drawing.Size(820, 82);
            ...
            panelTop.Controls.Add(lblXSens);
            panelTop.Controls.Add(txtXSens);
            panelTop.Controls.Add(lblYSens);
            panelTop.Controls.Add(txtYSens);
            ...
            chkEnable.Text = "启用测试（侧键2 → 锁头移动一次，CD 1s，不开枪）";
            ...
            btnEmergencyStop.Location = new System.Drawing.Point(400, y2 - 3);
            ...
            btnClear.Text = "清空日志";
            btnClear.Location = new System.Drawing.Point(490, y2 - 3);
            btnClear.Size = new System.Drawing.Size(70, 25);
            btnClear.Click += btnClear_Click;

            // X/Y 灵敏度：默认 GameConfig CF 2K（166/166），改完即时生效（下一次侧键2触发即用新值）
            lblXSens.Text = "X灵敏度:";
            lblXSens.Location = new System.Drawing.Point(570, y2 + 3);
            lblXSens.AutoSize = true;

            txtXSens.Text = "166";
            txtXSens.Location = new System.Drawing.Point(630, y2);
            txtXSens.Size = new System.Drawing.Size(50, 23);
            txtXSens.TextChanged += txtXSens_TextChanged;

            lblYSens.Text = "Y灵敏度:";
            lblYSens.Location = new System.Drawing.Point(690, y2 + 3);
            lblYSens.AutoSize = true;

            txtYSens.Text = "166";
            txtYSens.Location = new System.Drawing.Point(750, y2);
            txtYSens.Size = new System.Drawing.Size(50, 23);
            txtYSens.TextChanged += txtYSens_TextChanged;

            // === Row 3: 使用说明 ===
            int y3 = 66;

            lblHint.Text = "判定标准：移动过头 = 灵敏度偏高（调小），移动不足 = 灵敏度偏低（调大）";
            lblHint.Location = new System.Drawing.Point(10, y3);
        ...
        private System.Windows.Forms.Label lblXSens;
        private System.Windows.Forms.TextBox txtXSens;
        private System.Windows.Forms.Label lblYSens;
        private System.Windows.Forms.TextBox txtYSens;
